...
courseList = [{'code': 'GT', 'subject': u"Теория графов"},
              ...
              {'code': 'AL1SE', 'subject': u"Алгоритмы (подгруппа SE Опарина)"},
              {'code': 'AL1BI', 'subject': u"Алгоритмы (подгруппа BI Опарина)"},
              {'code': 'AL2', 'subject': u"Алгоритмы (подгруппа Фондаратова)"},
              {'code': 'ML1', 'subject': u"Математическая логика (подгруппа Москвина)"},
              {'code': 'ML2', 'subject': u"Математическая логика (подгруппа Исаева)"},
